...
<header class="site-header" id="sticky-header">
    ...
    <!-- Feature icon -->
    <div id="feature-icon" class="feature-section inner-page-white-section">
                        ...
                        <div class="advantage">
							<ul>
                                ...
                                <li>
                                    ...
                                    <!-- content -->
                                    <div class="advantage-content"> <h4>Worldwide leadership</h4>
                                ...
                                <li>
                                    ...
                                    <!-- content -->
                                    <div class="advantage-content"> <h4>Innovative ideas</h4>
                                ...
                                <li>
                                    ...
                                    <!-- content -->
                                    <div class="advantage-content"> <h4>Guaranted success</h4>
